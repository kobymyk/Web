...
public final class JdbcUtils {
    ...
    // ANSI
    public static final String SQL_SELECT_ALL = "SELECT id, name, dueDate, priority FROM  todo_list;";
    public static final String SQL_SELECT_ROW = "SELECT id, name, dueDate, priority FROM  todo_list;";
    public static final String DML_INSERT = "SELECT id, name, dueDate, priority FROM  todo_list;";
    // ORA ! null = ''
